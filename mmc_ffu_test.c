...
#define FW_CONFIG_ENABLED 0x00
#define FW_CONFIG_DISABLED 0x01
#define FW_CONFIG_NONE -1
...
static int __ffu_area_init_test(int blks, s8 data_sector_size)
{
	...
	kut_mmc_ext_csd_set_ffu(VER_DEFAULT, MODE_OPERATION_CODE_FFU_INSTALL,
		MODE_CONFIG_FFU, data_sector_size, FW_CONFIG_ENABLED,
